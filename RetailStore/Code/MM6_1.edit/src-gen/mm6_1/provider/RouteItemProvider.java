...
/**
 * This is the item provider adapter for a {@link mm6_1.Route} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RouteItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addFromPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Route_from_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Route_from_feature", "_UI_Route_type"),
						Mm6_1Package.Literals.ROUTE__FROM, true, false, false,
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Route_to_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Route_to_feature", "_UI_Route_type"),
						Mm6_1Package.Literals.ROUTE__TO, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected void addTravelTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Route_travelTime_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Route_travelTime_feature",
								"_UI_Route_type"),
						Mm6_1Package.Literals.ROUTE__TRAVEL_TIME, true, false, false,
	...
	protected void addDistancePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Mm6_1Package.Literals.ROUTE__DISTANCE, true, false, false,
						ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Route) object).getFrom();
