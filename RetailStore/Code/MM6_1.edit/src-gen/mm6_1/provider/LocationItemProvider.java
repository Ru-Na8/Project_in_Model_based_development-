...
/**
 * This is the item provider adapter for a {@link mm6_1.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addOrderIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Location_orderID_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Location_orderID_feature",
								"_UI_Location_type"),
						Mm6_1Package.Literals.LOCATION__ORDER_ID, true, false, false,
	...
	protected void addAddressPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Location_address_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Location_address_feature",
								"_UI_Location_type"),
						Mm6_1Package.Literals.LOCATION__ADDRESS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addOrdersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Location_orders_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Location_orders_feature",
								"_UI_Location_type"),
						Mm6_1Package.Literals.LOCATION__ORDERS, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Mm6_1Package.Literals.LOCATION__ORDERS);
		}
	...
	public String getText(Object object) {
		String label = ((Location) object).getOrderID();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(Mm6_1Package.Literals.LOCATION__ORDERS, Mm6_1Factory.eINSTANCE.createOrder()));
	}
