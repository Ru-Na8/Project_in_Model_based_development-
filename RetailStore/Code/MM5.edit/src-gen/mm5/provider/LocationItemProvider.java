...
/**
 * This is the item provider adapter for a {@link mm5.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Location_orderID_feature",
								"_UI_Location_type"),
						Mm5Package.Literals.LOCATION__ORDER_ID, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Location_address_feature",
								"_UI_Location_type"),
						Mm5Package.Literals.LOCATION__ADDRESS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Location_to_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Location_to_feature", "_UI_Location_type"),
						Mm5Package.Literals.LOCATION__TO, true, false, true, null, null, null));
	}
