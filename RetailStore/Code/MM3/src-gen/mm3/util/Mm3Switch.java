 ...
 * @generated
 */
public class Mm3Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Mm3Package.SPECIAL_CHARACTERISTICS: {
			SpecialCharacteristics specialCharacteristics = (SpecialCharacteristics) theEObject;
			T result = caseSpecialCharacteristics(specialCharacteristics);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Special Characteristics</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Special Characteristics</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSpecialCharacteristics(SpecialCharacteristics object) {
		return null;
	}
