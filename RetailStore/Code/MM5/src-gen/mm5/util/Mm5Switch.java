 ...
 * @generated
 */
public class Mm5Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Mm5Package modelPackage;
	...
	public Mm5Switch() {
		if (modelPackage == null) {
			modelPackage = Mm5Package.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Mm5Package.DISTANCE_MATRIX: {
			DistanceMatrix distanceMatrix = (DistanceMatrix) theEObject;
			T result = caseDistanceMatrix(distanceMatrix);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseDistanceMatrix(DistanceMatrix object) {
		return null;
	}
